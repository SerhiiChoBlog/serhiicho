...
var hljs = function () {
    ...
    const E = "[a-zA-Z]\\w*", x = "[a-zA-Z_]\\w*", y = "\\b\\d+(\\.\\d+)?", _ = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", w = "\\b(0b[01]+)", O = {
        ...
        }, G = Error(); function K(e, t, { key: n }) {
            let i = 0; const s = e[n], r = {}, o = {}
                ...
                if (Array.isArray(e.begin)) {
                    if (e.skip || e.excludeBegin || e.returnBegin) throw z("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),
                        ...
                        ; if ("object" != typeof e.beginScope || null === e.beginScope) throw z("beginScope must be object"),
                            G; K(e, e.begin, { key: "beginScope" }), e.begin = m(e.begin, { joinWith: "" })
                }
            })(e), (e => {
                if (Array.isArray(e.end)) {
                    if (e.skip || e.excludeEnd || e.returnEnd) throw z("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
                        ...
                        ; if ("object" != typeof e.endScope || null === e.endScope) throw z("endScope must be object"),
                            G; K(e, e.end, { key: "endScope" }), e.end = m(e.end, { joinWith: "" })
                }
            })(e)
        } function Z(e) {
            function t(t, n) {
    ...
    const J = n, Y = i, Q = Symbol("nomatch"), ee = n => {
        const i = Object.create(null), s = Object.create(null), r = []; let o = !0
            ; const a = "Could not find the language '{}', did you forget to load/include a language module?", l = {
                                ...
                                ; const s = w.case_insensitive ? t[0].toLowerCase() : t[0], r = (i = s, N.keywords[i]); if (r) {
                                    const [e, i] = r
                                        ; if (M.addText(n), n = "", c[s] = (c[s] || 0) + 1, c[s] <= 7 && (j += i), e.startsWith("_")) n += t[0]; else {
                                            const n = w.classNameAliases[e] || e; u(t[0], n)
                                        }
                                } else n += t[0]
                ...
                let y = {}; function _(i, r) {
                    const a = r && r[0]; if (R += i, null == a) return g(), 0
                    ...
                    if (y = r, "begin" === r.type) return (e => {
                        ...
                        ; if ("illegal" === r.type && !s) {
                            const e = Error('Illegal lexeme "' + a + '" for mode "' + (N.scope || "<unnamed>") + '"')
                                ; throw e.mode = N, e
                        } if ("end" === r.type) { const e = m(r); if (e !== Q) return e }
                    ...
                    ; if (!w) throw z(a.replace("{}", e)), Error('Unknown language: "' + e + '"')
                        ; const v = Z(w); let k = "", N = r || v; const S = {}, M = new p.__emitter(p); (() => {
                            const e = []
                ...
                if ("loading" === document.readyState) return _ || window.addEventListener("DOMContentLoaded", (() => {
                    w()
                }), !1), void (_ = !0); document.querySelectorAll(p.cssSelector).forEach(y)
            }
        ...
        function v(e, { languageName: t }) {
            ...
            removePlugin: e => { const t = r.indexOf(e); -1 !== t && r.splice(t, 1) }
        }), n.debugMode = () => {
            o = !1
        }, n.safeMode = () => { o = !0 }, n.versionString = "11.11.1", n.regex = {
            concat: h,
            ...
            const a = {
                ...
                contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, {
                    ...
                    excludeEnd: !0, contains: [e.TITLE_MODE, {
                        ...
                        endsParent: !0, keywords: a, illegal: /["']/
                    }]
                }]
            }
        }
    ...
    var e = (() => {
        "use strict"; return e => {
            const t = e.regex, a = /(?![A-Za-z0-9])(?![$])/, r = t.concat(/[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/, a), n = t.concat(/(\\?[A-Z][a-z0-9_\x7f-\xff]+|\\?[A-Z]+(?=[A-Z][a-z0-9_\x7f-\xff])){1,}/, a), o = t.concat(/[A-Z]+/, a), c = {
                ...
                variants: [{
                    match: [t.concat(/::/, t.lookahead(/(?!class\b)/)), m], scope: {
                        2: "variable.constant"
                    }
                }, { match: [/::/, /class/], scope: { 2: "variable.language" } }, {
                    match: [n, t.concat(/::/, t.lookahead(/(?!class\b)/)), m], scope: {
                        1: "title.class",
                        3: "variable.constant"
                    }
                }, {
                ...
                scope: { 3: "title.function.invoke" }, contains: [v]
            }; v.contains.push(O)
                ; const y = [f, I, e.C_BLOCK_COMMENT_MODE, d, _, h], w = {
                    ...
                    endScope: "meta", keywords: { literal: p, keyword: ["new", "array"] }, contains: [{
                        ...
                        contains: ["self", ...y]
                    }, ...y, { scope: "meta", variants: [{ match: n }, { match: o }] }]
                }
                ; return {
                    ...
                    contains: [w, e.HASH_COMMENT_MODE, e.COMMENT("//", "$"), e.COMMENT("/\\*", "\\*/", {
                        ...
                        }, { scope: "variable.language", match: /\$this\b/ }, c, O, I, {
                ...
                const a = (e => ({
                    ...
                    contains: [n.C_LINE_COMMENT_MODE, n.C_BLOCK_COMMENT_MODE, a.CSS_NUMBER_MODE, {
                        ...
                        begin: "@", end: "[{;]", returnBegin: !0, keywords: {
                            $pattern: /[a-z-]+/,
                            keyword: "and or not only", attribute: i.join(" ")
                        }, contains: [{
                            begin: d,
                            className: "keyword"
                        }, {
    ...
    var e = (() => {
        "use strict"; return e => {
            ...
            const c = {
                ...
                }, c, i, { scope: "variable", match: /@[a-z0-9][a-z0-9_]*/ }, {
            ...
            ; function o(o) {
                const l = o.regex, d = e, b = {
                    ...
                    ; y.contains = S.concat({
                        ...
                        begin: /(\s*)\(/, end: /\)/,
                        keywords: g, contains: ["self"].concat(v)
                    }]), R = {
                        className: "params", begin: /(\s*)\(/,
                        end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: g, contains: w
                    }, k = {
                    ...
                    ; return {
                        name: "JavaScript", aliases: ["js", "jsx", "mjs", "cjs"], keywords: g, exports: {
                            PARAMS_CONTAINS: w, CLASS_REFERENCE: x
                        }, illegal: /#(?![$_A-z])/,
                        contains: [o.SHEBANG({ label: "shebang", binary: "node", relevance: 5 }), {
                            label: "use_strict", className: "meta", relevance: 10,
                            begin: /^\s*['"]use (strict|asm)['"]/
                ...
                const s = t.regex, c = o(t), l = e, d = ["any", "void", "number", "boolean", "string", "object", "never", "symbol", "bigint", "unknown"], b = {
                    ...
                    beginKeywords: "interface", end: /\{/, excludeEnd: !0, keywords: {
                        keyword: "interface extends", built_in: d
                    ...
                    literal: a, built_in: i.concat(d), "variable.language": r
                }, m = {
                    className: "meta",
                    begin: "@" + l
                }, E = (e, n, a) => {
                    ...
                    ; return c.exports.PARAMS_CONTAINS.push([c.exports.CLASS_REFERENCE, A, y]),
                        ...
                        E(c, "shebang", t.SHEBANG()), E(c, "use_strict", {
